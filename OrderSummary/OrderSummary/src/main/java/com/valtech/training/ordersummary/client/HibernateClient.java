...
//		session1.persist(new Customer("Poojitha", "Rakshitha Appartment,Banglore", "9910369104"));
		Customer customer1 = new Customer("Poojitha", " Nagarbhavi ,Banglore", "9910369104");
