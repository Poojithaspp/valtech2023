package com.valtech.training.employeespringboot.service;
...
import com.valtech.training.employeespringboot.entity.Department;
import com.valtech.training.employeespringboot.entity.Employee;
import com.valtech.training.employeespringboot.repository.DepartmentRepo;
import com.valtech.training.employeespringboot.repository.EmployeeRepo;
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public void populateEmployee() {
		...
		Employee emp = new Employee("Poojitha",21,1,1,45000);
		Employee emp1 = new Employee("Gagana",20,1,1,45000);
		Employee emp2 = new Employee("Manjushree",20,1,1,45000);
		Employee emp3 = new Employee("Shreya",20,1,1,45000);
